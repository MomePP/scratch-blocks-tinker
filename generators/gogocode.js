...
Blockly.GogoCode.init = function() {
  ...
  if (Blockly.Variables) {
    if (!Blockly.GogoCode.variableDB_) {
      Blockly.GogoCode.variableDB_ = new Blockly.Names(
        Blockly.GogoCode.RESERVED_WORDS_
      );
    } else {
...
Blockly.GogoCode["display_number"] = function(block) {
  //var text_input = block.getFieldValue('text');
  var value_value = Blockly.GogoCode.valueToCode(
    block,
    "value",
...
Blockly.GogoCode["i2c_write"] = function(block) {
  ...
  var text_reg_addr = Blockly.GogoCode.valueToCode(
    block,
    "reg_addr",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var text_i2c_addr = Blockly.GogoCode.valueToCode(
    block,
    "i2c_addr",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  ...
  var code =
    '<span class="c210">i2cwrite [write: \'' +
    value_value +
    "', reg_address: " +
    text_reg_addr +
    ", i2c_address: " +
...
Blockly.GogoCode["i2c_read"] = function(block) {
  ...
  var code =
    '<span class="c210">i2cread [reg_address: ' +
    text_reg_addr +
    ", i2c_address: " +
    text_i2c_addr +
    "]</span>\n";
  var code =
    '<span class="c210">(i2cread ' +
    text_i2c_addr +
    " " +
    text_reg_addr +
    ")</span>";
...
Blockly.GogoCode["key_value"] = function(block) {
  ...
  var text_key_value_input = Blockly.GogoCode.valueToCode(
    block,
    "key_value_input",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var code =
    ...
    text_key_name +
    '" = ' +
    text_key_value_input +
    "</span>";
  return [code, Blockly.GogoCode.ORDER_NONE];
};

Blockly.GogoCode["get_int_value_of_key"] = function(block) {
  var text_key_name = Blockly.GogoCode.valueToCode(
    block,
    "key_name",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode["if_telegram_message"] = function(block) {
  ...
  var code =
    '<span class="c210">key "telegram" = ' + text_key_value_input + "</span>";
  return [code, Blockly.GogoCode.ORDER_NONE];
};
...
Blockly.GogoCode["action_wait"] = function(block) {
  var value_name = Blockly.GogoCode.valueToCode(
    block,
    "NAME",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.action_motor_is_cw = function() {
  ...
  var code =
    ...
    (checkbox_d == "TRUE" ? "d" : "") +
    "thisway?</span> \n"; //+value_name.slice(1, value_name.length-1)+'\n';
  if (code == '<span class="c316">thisway?</span> \n') {
    code = '<span class="c316">0</span>';
  }
  return [code, Blockly.GogoCode.ORDER_NONE];
};
...
Blockly.GogoCode.motor_action_onfor = function(block) {
  //var value_right = Blockly.GogoCode.valueToCode(this, 'right', Blockly.GogoCode.ORDER_ATOMIC);
  var text_second = Blockly.GogoCode.valueToCode(
    block,
    "value",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.motor_action_power = function(block) {
  ...
  var value_power = Blockly.GogoCode.valueToCode(
    block,
    "power",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode["servo_seth"] = function(block) {
  ...
  var value_heading = Blockly.GogoCode.valueToCode(
    block,
    "heading",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.control_if = function() {
  ...
  var statements_statement = Blockly.GogoCode.statementToCode(
    this,
    "statement"
  );
...
Blockly.GogoCode.control_repeat = function() {
  var value_times = Blockly.GogoCode.valueToCode(
    this,
    "times",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.control_do_every = function() {
  var period = Blockly.GogoCode.valueToCode(
    this,
    "period",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.control_if_ticked = function() {
  ...
  // TODO: Assemble GogoCode into code variable.
  var code =
    '<span class="c120">if tickcount > 0\n[' +
    statements_do +
    "\ncleartick\n]\n</span>\n";
  return code;
};
...
//};
Blockly.GogoCode["key_text"] = function(block) {
  var value_key = Blockly.GogoCode.valueToCode(
    block,
    "key",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.input__output__storage_setdp = function() {
  var value_dp = Blockly.GogoCode.valueToCode(
    this,
    "DP",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.input__output__storage_send_serial = function() {
  var value_send = Blockly.GogoCode.valueToCode(
    this,
    "send",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.math_number = function() {
  ...
  var code =
    '<span class="c10">' + (isNaN(text_number) ? 0 : text_number) + "</span>";
  return [code, Blockly.GogoCode.ORDER_NONE];
};
...
Blockly.GogoCode.math_equal = function() {
  var value_left = Blockly.GogoCode.valueToCode(
    this,
    "left",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var value_right = Blockly.GogoCode.valueToCode(
    this,
    "right",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.math_in_between = function() {
  var value_input = Blockly.GogoCode.valueToCode(
    this,
    "input",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var value_lower = Blockly.GogoCode.valueToCode(
    this,
    "lower",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var value_upper = Blockly.GogoCode.valueToCode(
    this,
    "upper",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.math_operator = function() {
  var value_1stnum = Blockly.GogoCode.valueToCode(
    this,
    "1stNum",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var value_2ndnum = Blockly.GogoCode.valueToCode(
    this,
    "2ndNum",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.math_not = function() {
  var value_bool = Blockly.GogoCode.valueToCode(
    this,
    "bool",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.send_string_message = function(block) {
  var message = Blockly.GogoCode.valueToCode(
    block,
    "message",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var topic = Blockly.GogoCode.valueToCode(
    block,
    "topic",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var code =
    '<span class="c330">sendmessage ' + topic + "  " + message + "</span>\n";
  return code;
};
...
Blockly.GogoCode.ifttt_trigger = function(block) {
  ...
  var code =
    '<span class="c330">sendmessage "@ifttt,' +
    topic +
    '" ' +
    message +
    "</span>\n";
...
Blockly.GogoCode.telegram_message = function(block) {
  ...
  var code =
    '<span class="c330">sendmessage "@telegram,' +
    message_type +
    '" ' +
    message +
    "</span>\n";
...
Blockly.GogoCode.send_sms = function(block) {
  ...
  var number = Blockly.GogoCode.valueToCode(
    block,
    "number",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var code =
    '<span class="c330">sendsms ' + number + " " + message + "</span>\n";
  return code;
};

Blockly.GogoCode.send_email = function(block) {
  var email = Blockly.GogoCode.valueToCode(
    block,
    "email",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var title = Blockly.GogoCode.valueToCode(
    block,
    "title",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var body = Blockly.GogoCode.valueToCode(
    block,
    "body",
    Blockly.GogoCode.ORDER_ATOMIC
  );
  var code =
    '<span class="c330">sendmail ' +
    email +
    " " +
    title +
    " " +
...
Blockly.GogoCode["play_sound"] = function(block) {
  var value_string = Blockly.GogoCode.valueToCode(
    block,
    "string",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode["record_as"] = function(block) {
  var value_expression = Blockly.GogoCode.valueToCode(
    block,
    "expression",
    Blockly.GogoCode.ORDER_ATOMIC
  );
...
Blockly.GogoCode.data_setvariableto = function() {
  ...
  var argument0 =
    Blockly.GogoCode.valueToCode(
      this,
      "VALUE",
      Blockly.GogoCode.ORDER_ASSIGNMENT
    ) || "0";
...
Blockly.GogoCode.procedure_procedure = function() {
  ...
  var code =
    '[p]<span class="c210">to ' +
    text_pname +
    '</span><span class="c0">newline</span>\n[SS]' +
    statements_statement +
    '<span class="c0">newline</span><span class="c210">end</span>[/p]';
  return code;
};
...
Blockly.GogoCode["procedures_defreturn"] = function(block) {
  ...
  if (Blockly.GogoCode.INFINITE_LOOP_TRAP) {
    branch =
      Blockly.GogoCode.INFINITE_LOOP_TRAP.replace(/%1/g, "'" + block.id + "'") +
      branch;
  }
  var returnValue =
    Blockly.GogoCode.valueToCode(
  ...
  code =
    '[p]<span class="c0">newline</span><span class="c0">newline</span>to ' +
    funcName +
    " " +
    args.join(" ") +
    '<span class="c0">newline</span>\n ' +
    branch +
    '\n<span class="c0">newline</span>' +
    returnValue +
...
Blockly.GogoCode["procedures_defnoreturn"] =
  Blockly.GogoCode["procedures_defreturn"];

Blockly.GogoCode.procedures_callnoreturn = function(a) {
  var b = Blockly.GogoCode.variableDB_.getName(
