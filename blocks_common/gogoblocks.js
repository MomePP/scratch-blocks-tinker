...
Blockly.Blocks["display_number"] = {
  init: function() {
    ...
    //        .appendField(new Blockly.FieldTextInput("text"), "text")
    //        .appendField("\"");
    this.appendDummyInput().appendField("show number  ");
...
Blockly.Blocks["recorder_play"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(90);
    this.appendDummyInput().appendField("Play Track");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
  }
...
Blockly.Blocks["recorder_next"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(90);
    this.appendDummyInput().appendField("Next Track");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
  }
...
Blockly.Blocks["recorder_prev"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(90);
    this.appendDummyInput().appendField("Prev Track");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
  }
...
Blockly.Blocks["recorder_eraseall"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(90);
    this.appendDummyInput().appendField("Erase All Tracks");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
  }
...
Blockly.Blocks["i2c_write"] = {
  init: function() {
    ...
    //        .appendField(", ");
    //    this.setInputsInline(true);
    this.appendValueInput("value").appendField("I2C Write value ");
    this.appendValueInput("reg_addr").appendField("to register# ");
    this.appendValueInput("i2c_addr").appendField(" on device address# ");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks["i2c_read"] = {
  init: function() {
    ...
    //    this.appendValueInput("value")
    //        .appendField("");
    this.appendValueInput("reg_addr").appendField("I2C Read from register# ");
    this.appendValueInput("i2c_addr").appendField(" on device address# ");
    this.setInputsInline(true);
    this.setOutput(true);
    this.setTooltip("");
...
Blockly.Blocks["action_settickrate"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(170);
    this.appendDummyInput().appendField("Tick every");
    this.appendValueInput("NAME", Number);
    this.appendDummyInput().appendField("1/10 second(s)");
    this.setInputsInline(true);
...
Blockly.Blocks.control_forever_wait = {
  ...
  init: function() {
    ...
    this.appendDummyInput().appendField("each time wait");
    this.appendValueInput("NAME", Number);
    this.appendDummyInput().appendField("1/10 second(s)");
    this.setInputsInline(true);
...
Blockly.Blocks.input__output__storage_new_serial = {
  ...
  init: function() {
    ...
    this.setOutput(true, Boolean);
    this.setTooltip(
      "Reports whether value from serial port has been received."
    );
  }
};
...
Blockly.Blocks.key_value = {
  ...
  init: function() {
    ...
    this.appendValueInput("key_value_input").appendField("is equal to ");
...
Blockly.Blocks.get_int_value_of_key = {
  ...
  init: function() {
    this.setColour(290);
    this.appendValueInput("key_name").appendField("Number value of key");
...
Blockly.Blocks.key_value_unrestricted = {
  ...
  init: function() {
    ...
    this.appendValueInput("key_name").appendField("Key");
    this.appendValueInput("key_value_input").appendField("is equal to ");
...
Blockly.Blocks.send_string_message = {
  ...
  init: function() {
    ...
    this.appendValueInput("message").appendField("Submit text ");
    this.appendValueInput("topic").appendField("to topic ");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks.send_number_message = {
  ...
  init: function() {
    ...
    this.appendValueInput("message", Number).appendField("Submit number ");
    this.appendValueInput("topic").appendField("to topic");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Blocks.ifttt_trigger = {
  ...
  init: function() {
    ...
    this.appendValueInput("topic").appendField("Send IFTTT event ");
    this.appendValueInput("message").appendField(" with text / value");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks.telegram_message = {
  ...
  init: function() {
    this.setColour(330);
    this.appendDummyInput()
      .appendField("Send Telegram ")
      .appendField(
        new Blockly.FieldDropdown([["Message", "message"], ["Image", "image"]]),
        "message_type"
      );
    this.appendValueInput("message").appendField(" value");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks.if_telegram_message = {
  ...
  init: function() {
    this.setColour(290);
    this.appendValueInput("key_value_input").appendField(
      "Telegram message is equal to"
    );
    this.setInputsInline(true);
    this.setOutput(true, Boolean);
    this.setTooltip("Reports value of specific key.");
...
Blockly.Blocks.math_in_between = {
  ...
  init: function() {
    ...
    this.appendValueInput("lower", Number).appendField("is in between");
    this.appendValueInput("upper", Number).appendField(",");
...
Blockly.Blocks.use_sms = {
  ...
  init: function() {
    this.setColour(330);
    this.appendDummyInput().appendTitle("Use SMS");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.send_sms = {
  ...
  init: function() {
    ...
    this.appendValueInput("number").appendField("Send SMS to : ");
    this.appendValueInput("message").appendField(", message : ");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks.send_email = {
  ...
  init: function() {
    ...
    this.appendValueInput("email").appendField("Send Email to : ");
    this.appendValueInput("title").appendField(", title : ");
...
Blockly.Blocks.userfid = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput().appendTitle("Use RFID");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.read_from_rfid = {
  ...
  init: function() {
    this.setColour(230);
    this.appendDummyInput().appendTitle("Read from RFID");
    this.setInputsInline(true);
...
Blockly.Blocks.write_to_rfid = {
  ...
  init: function() {
    this.setColour(230);
    this.appendValueInput("NAME").appendTitle("Write to RFID");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
  }
...
Blockly.Blocks.use_finer_scan = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Use Finger Scan");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.identify_finger = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Identify Finger");
    this.setInputsInline(true);
    this.setOutput(true, String);
    this.setTooltip("");
  }
...
Blockly.Blocks.enroll_finger = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Enroll Finger");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.use_camera = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Use camera");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.close_camera = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Close camera");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.start_find_face = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Start Find-Face");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.stop_find_face = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Stop Find-Face");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.take_snapshot = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Take snapshot");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks.found_face = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Found a Face?");
    this.setInputsInline(true);
    this.setOutput(true, Boolean);
    this.setTooltip("");
  }
...
Blockly.Blocks.camera_is_on = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Camera is on?");
    this.setInputsInline(true);
    this.setOutput(true, Boolean);
    this.setTooltip("");
  }
...
Blockly.Blocks.find_face_is_on = {
  ...
  init: function() {
    this.setColour(160);
    this.appendDummyInput().appendTitle("Find-Face is on?");
    this.setInputsInline(true);
    this.setOutput(true, Boolean);
    this.setTooltip("");
  }
...
Blockly.Blocks["play_sound"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(170);
    this.appendValueInput("string").appendField("Play Sound");
    this.setInputsInline(true);
    this.setPreviousStatement(true, "null");
    this.setNextStatement(true, "null");
    this.setTooltip("");
...
Blockly.Blocks["stop_sound"] = {
  ...
  init: function() {
    this.setColour(170);
    this.appendDummyInput().appendTitle("Stop sound");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks["say"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(170);
    this.appendValueInput("string").appendField("Say");
    this.setInputsInline(true);
    this.setPreviousStatement(true, "null");
    this.setNextStatement(true, "null");
    this.setTooltip("");
...
Blockly.Blocks["show_image"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(165);
    this.appendValueInput("string").appendField("Show image");
    this.setInputsInline(true);
    this.setPreviousStatement(true, "null");
    this.setNextStatement(true, "null");
    this.setTooltip("");
...
Blockly.Blocks["hide_image"] = {
  ...
  init: function() {
    this.setColour(165);
    this.appendDummyInput().appendTitle("Hide image");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
...
Blockly.Blocks["screen_tapped"] = {
  ...
  init: function() {
    this.setColour(165);
    this.appendDummyInput().appendTitle("Screen tapped?");
    this.setInputsInline(true);
    this.setOutput(true, Boolean);
    this.setTooltip("");
  }
...
Blockly.Blocks["new_record"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(130);
    this.appendValueInput("string").appendField("New record file for");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks["record_as"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(130);
    this.appendValueInput("expression").appendField("Record");
    this.appendValueInput("string").appendField("as");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks["show_plot"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(130);
    this.appendValueInput("string").appendField("Show plot of ");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks["show_plot_expression"] = {
  init: function() {
    this.setHelpUrl("http://www.example.com/");
    this.setColour(130);
    this.appendValueInput("expression").appendField("Show plot for last ");
    this.appendValueInput("string").appendField("values of ");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("");
...
Blockly.Blocks["test_do_sth"] = {
  ...
  decompose: function(workspace) {
    var containerBlock = Blockly.Block.obtain(workspace, "test_condition");
